...
class Adamatch():
    ...
    def train(self, source_dataloader_weak, source_dataloader_strong,
        ...
        for epoch in range(start_epoch, epochs):
            ...
            for (data_source_weak, labels_source), (data_source_strong, _), (data_target_weak, _), (data_target_strong, _) in dataset:
                ...
                logits_combined = self.model(data_combined)
                # print('logits_combined,',logits_combined.shape)
                ...
                logits_source_pp = self.model(source_combined)
            ...
            if test_epoch_accuracy > best_acc:
                ...
                #             }, save_path)
                torch.save({'model_weights': self.medel.state_dict(),
                            }, save_path)
    ...
    def _compute_source_loss(logits_weak, logits_strong, labels):
        ...
        # print("logits_weak.shape,labels.shape",logits_weak.shape,labels.shape)
