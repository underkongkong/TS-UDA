...
class MMASleepNet_eeg_plus_encoder(BasicModel):
    def __init__(self,cfg):#,d_model,afr_reduced_cnn_size):
        super(MMASleepNet_eeg_plus_encoder, self).__init__()
        ...
        self.linear1 = nn.Sequential(nn.Linear(self.d_model*self.afr_reduced_cnn_size*32,128),nn.ReLU(True))
